...
public class SNSRosterManager {
	 ...
	 */
	public static final String ACTION_REQUEST_DELETE = "com.research.sns.roster.admin.ACTION_REQUEST_DELETE";
	/**
	 * 添加好友请求<br/>
	 * 附加参数<br/>
	 ...
	 * <b>Value:</b> String  chatId
	 */
	public static final String ACTION_REQUEST_ADD = "com.research.sns.roster.admin.ACTION_REQUEST_ADD";
	 ...
	 */
	public static final String ACTION_RESULT_DELETE = "com.research.sns.roster.admin.ACTION_RESULT_DELETE";
	 ...
	 * <b>Value:</b> boolean  state
	 */
	public static final String ACTION_RESULT_ADD = "com.research.sns.roster.admin.ACTION_RESULT_ADD";
