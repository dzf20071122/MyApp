...
import com.research.receiver.ConnectivityReceiver;
import com.research.receiver.NotificationReceiver;
import com.research.receiver.PhoneStateChangeListener;
import com.research.service.type.XmppType;
import com.research.service.type.XmppTypeManager;
...
public class SnsService extends Service{
	...
	public void onCreate() {
		...
		userInfoVo = ResearchCommon.getLoginResult(BMapApiApp.getInstance());
		try {
