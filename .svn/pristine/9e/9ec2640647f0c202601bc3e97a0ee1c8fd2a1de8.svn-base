...
import com.research.service.XmppManager;
...
public class NotifySystemMessage implements NotifyMessage{
	 ...
	 */
	public static final String ACTION_NOTIFY_SYSTEM_MESSAGE = "com.research.sns.notify.ACTION_NOTIFY_SYSTEM_MESSAGE";
	 ...
	 *  */
	public static final String ACTION_VIP_STATE = "com.research.sns.notify.ACTION_VIP_STATE";
