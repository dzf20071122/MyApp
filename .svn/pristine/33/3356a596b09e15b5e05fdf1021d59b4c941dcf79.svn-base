...
public class SearchResultActivity extends BaseActivity implements OnClickListener, OnItemClickListener{
	...
	public static final String REFRSCH_ITEM_ACTION = "com.research.intent.action.refresh_ACTION";
		...
		new Thread(){
			public void run() {
				try {
					...
					if (isExitsData) {
						mUser = ResearchCommon.getResearchInfo().search_number(mSearchContent,page);
