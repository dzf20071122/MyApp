	...
	public boolean sendMessage(MessageInfo info, String group) {
		...
		if(chat != null){
			try {
				...
				/*if(ResearchCommon.getLoginResult(BMapApiApp.getInstance())!=null){
					if(ResearchCommon.getLoginResult(BMapApiApp.getInstance()).type >=2 ){
						json.put("isUser", 1);
					}
				}*/
