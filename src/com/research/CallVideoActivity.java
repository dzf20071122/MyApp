...
public class CallVideoActivity extends CallActivity  implements OnClickListener {
	...
	private ImageView swingCardImage;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        swingCardImage = (ImageView) findViewById(R.id.swing_card);
		if(firendLogin!=null){
			Object obj=null;
			obj=mImageLoader.getBitmap(mContext, swingCardImage, null, firendLogin.headsmall, 0, false, true);
			Log.i("Runt","CallVideoActivity加载头像obj："+obj);
			if(obj==null){
				Log.i("Runt","CallVideoActivity加载头像失败");
			}
		}else{
			Log.i("Runt","fCallVideoActivityirendLogin:"+firendLogin);
		}
        ...
        // 设置通话人
        nickTextView.setText(firendLogin.nickname);
		Log.i("Runt","CallVideoActivity 设置通话人:"+firendLogin.nickname);
            ...
            if (!cameraHelper.isStarted()) {
                if (!isInComingCall) {
                    try {
                        ...
                        Toast.makeText(mContext, R.string.Is_not_yet_connected_to_the_server , 1).show();
                    }
                }
                ...
                case ACCEPTED: // 电话接通成功
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            // 开始记时
                            chronometer.start();
                            swingCardImage.setVisibility(View.INVISIBLE);
