...
public class CallVoiceActivity extends CallActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(firendLogin!=null){
			...
			Log.i("Runt","firendLogin:"+firendLogin);
		}
		...
		Log.i("Runt","CallVoiceActivity username:"+username);
		// 语音电话是否为接收的
		isInComingCall = getIntent().getBooleanExtra("isComingCall", false);

		// 设置通话人
		nickTextView.setText(firendLogin.nickname);
		Log.i("Runt","CallVoiceActivity 设置通话人:"+firendLogin.nickname);
		if (!isInComingCall) {// 拨打电话
			...
			try {
				// 拨打语音电话
				Log.i("Runt","CallVoiceActivity 拨打语音电话 makeVoiceCall:"+username);
