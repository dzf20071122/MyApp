	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case GlobalParam.MSG_SHOW_HEADER_IMG://显示背景图
				Log.i("Runt","MyAlbumActivity mHeaderIcon:"+mHeaderIcon);
				if(mHeaderIcon!=null){
					mHeaderIcon.setImageBitmap(null);
					Log.i("Runt","MyAlbumActivity mHeadUrl:"+mHeadUrl);
					if (mHeadUrl!=null && !mHeadUrl.equals("")) {
						...
						Object obj=mImageLoader.getBitmap(mContext, mHeaderIcon, null,mHeadUrl, 0,true,false);
						Log.i("Runt","MyAlbumActivity 设置头像"+obj);
					}else{
						mHeaderIcon.setImageResource(R.drawable.contact_default_header);
					}
				}
