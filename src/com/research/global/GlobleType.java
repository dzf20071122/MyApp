...
public class GlobleType {
	...
	public final static int COMPLETE_MKFRIEND_XUANYAN = 00101;// 交友宣言
	public final static int COMPLETE_MKFRIEND_REQUIRE = 00102;// 交友要求
	public final static int COMPLETE_XIANGQIN_NAME = 00103;// 真实姓名
	public final static int COMPLETE_XIANGQIN_XUANYAN = 00104;// 相亲宣言
	public final static int COMPLETE_XIANGQIN_REQUIRE = 00105;// 相亲要求
	...
	/*
	 * //我的评论和我赞过的微博类型 public final static int MYZANACTIVITY_MY_ZAN_TYPE =
	 * 0;//我赞过的 public final static int MYZANACTIVITY_MY_COMMEN_TYPE = 1;//我的评论
	 */
	// 隐私设置和新消息通知设置
	...
	public final static int ADAPTER_FROM_XIANGQIN_TYPE = 0;// 来自相亲界面
	public final static int ADAPTER_FROM_MAKEFRIEND_TYPE = 1;// 来自交友墙
