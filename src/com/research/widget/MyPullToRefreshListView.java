...
public class MyPullToRefreshListView extends LinearLayout{
	...
	private int mCurRefreshViewHeight = 45;
	private int TOP_LAYOUTHEIGHT = 45;
	...
	private void changeState(int state) {
		...
		case STATE_PULL:
			...
			mRefreshProgress.setVisibility(View.GONE);
			 mRefreshViewText.setText(mContext.getString(R.string.continuetorefresh));
			changeRefreshView(true);
			break;
		case STATE_RELEASE:
			mRefreshViewImage.setVisibility(View.VISIBLE);
			mRefreshProgress.setVisibility(View.GONE);
			 mRefreshViewText.setText(mContext.getString(R.string.starttorefresh));
			changeRefreshView(false);
			break;
		case STATE_LOADING:
			mRefreshViewImage.setVisibility(View.GONE);
			mRefreshProgress.setVisibility(View.VISIBLE);
			mRefreshViewText.setText(mContext.getString(R.string.refreshloading));
	...
	public void setRefreshViewHeight(int height) {
		...
		if (height == 1) {
			...
			mRefreshView.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, FeatureFunction.dip2px(mContext, 45)));
		} else {
