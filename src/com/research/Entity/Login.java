  ...
  "state": {
	...
	public Login(JSONObject json) {
		try {
			...
			if(!json.isNull("friend_xuanyan")){
				makeFriendXuanyan = json.getString("friend_xuanyan");
			}
			
			if(!json.isNull("friendRequire")){
				makeFriendRequre = json.getString("friendRequire");
			}
			if(!json.isNull("friend_require")){
				makeFriendRequre = json.getString("friend_require");
			}
			
			if(!json.isNull("blindDateXuanYan")){
				blindDate = json.getString("blindDateXuanYan");
			}
			if(!json.isNull("blind_date_xuanyan")){
				blindDate = json.getString("blind_date_xuanyan");
			}
			...
			if(!json.isNull("blind_date_require")){
				blindDateRequre = json.getString("blind_date_require");
			}
			if(!json.isNull("age")){
				old = json.getInt("age");
			}
