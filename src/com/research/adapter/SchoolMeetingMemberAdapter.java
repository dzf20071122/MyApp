...
public class SchoolMeetingMemberAdapter extends BaseAdapter implements SectionIndexer{
	private List<Login> list = null;
	private Context mContext;
	private ImageLoader mImageLoader;

	public SchoolMeetingMemberAdapter(Context mContext, List<Login> list) {
