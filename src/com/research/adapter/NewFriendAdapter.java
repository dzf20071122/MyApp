	...
	public View getView(final int position, View convertView, ViewGroup arg2) {
        ...
        if(user != null){
			...
			case 0://添加 好友申请
				...
				holder.mCancelBtn.setText(BMapApiApp.getInstance().getResources().getString(R.string.add));
			...
			case 3://同意好友的请求
				...
				holder.mCancelBtn.setText(BMapApiApp.getInstance().getResources().getString(R.string.accept));
				break;
			case 1://已添加
				holder.mCancelBtn.setBackgroundDrawable(null);
				holder.mCancelBtn.setText(BMapApiApp.getInstance().getResources().getString(R.string.has_added));
				break;
			case 2://等待验证
				holder.mCancelBtn.setBackgroundDrawable(null);
				holder.mCancelBtn.setText(BMapApiApp.getInstance().getResources().getString(R.string.validing));
        ...
        holder.mCancelBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				switch (user.type) {
				case 0://发送添加好友邀请
					ResearchCommon.sendMsg(mHandler, GlobalParam.MSG_VALID_FRIENDS,position);
					break;
				case 3://添加好友
					ResearchCommon.sendMsg(mHandler, GlobalParam.MSG_AGREE_ADD_FRIENDS_REQUEST,position);
					break;
				case 2://等待验证不处理
					break;
