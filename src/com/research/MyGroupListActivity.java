...
import com.research.adapter.RoomAdapter;
...
import com.research.widget.SearchDialog;

public class MyGroupListActivity extends BaseActivity{
	public final static String DELETE_ROOM_SUCCESS = "research_delete_contact_room_success";
	public final static String DELETE_ROOM_ACTION = "research_delete_room_action";
	public final static String DELETE_ROOM_FAILED = "research_delete_room_failed";
	public final static String MY_ROOM_BE_DELETED_ACTION = "research_my_room_list_be_deleted_action";
	public final static String REFRESH_ROOM_ACTION = "research_refresh_room_list_action";
	public static final String DESTORY_MYGroupList_ACTION = "com.research.intent.action.DESTORY_MYGROUPLIST_ACTION";
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(action.equals(DELETE_ROOM_ACTION)){
				...
				if(delPos!=-1){
					delete(delPos);
					hideProgressDialog();
					Toast.makeText(mContext, BMapApiApp.getInstance().getResources().getString(R.string.operate_success), Toast.LENGTH_SHORT).show();

				}
				
			}else if(action.equals(DELETE_ROOM_FAILED)){//删除群失败
				hideProgressDialog();
				Toast.makeText(mContext, BMapApiApp.getInstance().getResources().getString(R.string.operate_failed), Toast.LENGTH_SHORT).show();
